    ...
    return (
        <View style={{ width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
            <View style={{ width: '7%', height: '75%', display: 'flex', flexDirection: 'column' }}>
                ...
                <View style={{ marginTop: 4, height: 15, width: 10, borderRightWidth: 1, borderColor: 'red', borderStyle: 'dotted' }} />

                <View style={{ marginTop: 4, marginBottom: 10 }}>
                    <MaterialCommunityIcons name={icon as never} size={20} color="black" />
                </View>

                <View style={{ height: 15, width: 10, marginBottom: 5, borderRightWidth: 1, borderColor: 'red', borderStyle: 'dotted' }} />
